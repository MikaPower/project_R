  ...
  for (class in classes) {
    ...
    for (excel in excel_files) {
      ...
      calculate_graph <- function(table, names, title_graph, title_dir, sort = TRUE, df, count) {
        ...
        labels_top_spin_direita<- matrix('spin_direita')
        labels_top_spin_esquerda <- matrix('spin_esquerda')
        labels_bloco <- matrix('bloco')
        labels_flip_direita <- matrix('flip_direita')
        labels_flip_esquerda <- matrix('flip_esquerda')
